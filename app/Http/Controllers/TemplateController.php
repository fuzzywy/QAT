...
class TemplateController extends Controller 
{
    public function getTemplate() {
        ...
        switch ($dataType) {
               case 'TDD':
                    $arr = array(array('value'=>'常用指标模板','label'=>'常用指标模板'),
                                   array('value'=>'csfb回落','label'=>'csfb回落') );
                    break;
               case 'FDD':
                    $arr = array(array('value'=>'fdd干扰统计','label'=>'fdd干扰统计'));
                    break;
               case 'NBIOT':
                    $arr = array(array('value'=>'NB指标','label'=>'NB指标'),
                                   array('value'=>'NB指标模板G1','label'=>'NB指标模板G1') );
                    break;
               case 'GSM':
                    $arr = array(array('value'=>'2G指标','label'=>'2G指标'),
                                   array('value'=>'GSM三项','label'=>'GSM三项') );
                    break;
               default:
                    $arr = array();
                    break;
