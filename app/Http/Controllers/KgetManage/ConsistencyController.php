...
{   
    ...
    */
    public function getItem() {
        ...
        $itemTreeData = [];
        $itemTreeData = ConsistencyCheckTableInfo::select('item as label')->where('status','=','Y')->groupBy('item')->get()->toArray();
        return json_encode($itemTreeData);
    ...
    */
    public function getOperator() {
        ...
        $operatorData = DB::table('operator')->select('name as label','name as value')->where('province','=',$province)->get()->toArray();
        return json_encode($operatorData);
    ...
    */
    public function getProvince() {
        ...
        $provinceData = [];
        $provinceData = DB::table('province')->select('name as label','name as value')->get()->toArray();
        return json_encode($provinceData);
